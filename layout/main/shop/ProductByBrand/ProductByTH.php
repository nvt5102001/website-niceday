...
$sql_sp = "SELECT * FROM tblproduct WHERE tblproduct.BrandID='$_GET[BrandID]' ORDER BY ProductID DESC LIMIT $begin,9";
    ...
    <div class="shop-right-area">
        <div class="shop-tab-area">
            ...
            <div class="tab-content">
                ...
                <?php
                $sql_trang = "SELECT * FROM tblproduct WHERE tblproduct.BrandID='$_GET[BrandID]' ORDER BY ProductID DESC";
                ...
                ?>
                    ...
                    <ul class="list_trang">
                        ...
                        for ($i = 1; $i <= $trang; $i++) {
                        ?>
                            <li><a href="index.php?page=thuonghieu&trang=<?php echo $i ?>&BrandID=<?php echo $_GET["BrandID"] ?>"><?php echo $i ?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
