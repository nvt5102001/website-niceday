...
$ids = $_GET['ids'];
$id_array = explode(',', $ids); // Tách chuỗi ids thành mảng các giá trị ID
$id_list = implode(',', $id_array); // Chuyển đổi mảng thành chuỗi giá trị ID được phân tách bằng dấu phẩy

$sql_sp = "SELECT * FROM tblproduct WHERE ProductID IN ($id_list) LIMIT $begin,9";
    ...
    <div class="shop-right-area">
        <div class="shop-tab-area">
            ...
            <div class="tab-content">
                ...
                $sql_trang = "SELECT * FROM tblproduct WHERE ProductID IN ($id_list)";
                ...
                ?>
                    ...
                    <ul class="list_trang">
                        ...
                        for ($i = 1; $i <= $trang; $i++) {
                        ?>
                            <li><a href="index.php?page=price&trang=<?php echo $i ?>&ids=<?php echo $_GET['ids'] ?>"><?php echo $i ?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
