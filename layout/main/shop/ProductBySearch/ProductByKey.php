...
$sql_sp = "SELECT * FROM tblproduct,tblbrand WHERE tblproduct.BrandID = tblbrand.BrandID AND (tblproduct.ProductName LIKE '%" . $tukhoa . "%' OR tblbrand.BrandName LIKE '%" . $tukhoa . "%') LIMIT $begin,9";
    ...
    <div class="shop-right-area">
        <div class="shop-tab-area">
            ...
            <div class="tab-content">
                ...
                <?php
                $sql_trang = "SELECT * FROM tblproduct,tblbrand WHERE tblproduct.BrandID = tblbrand.BrandID AND (tblproduct.ProductName LIKE '%" . $tukhoa . "%' OR tblbrand.BrandName LIKE '%" . $tukhoa . "%')";
                ...
                <ul class="list_trang">
                    ...
                    for ($i = 1; $i <= $trang; $i++) {
                    ?>
                        <li><a href="index.php?page=timkiem&trang=<?php echo $i ?>"><?php echo $i ?></a></li>
                    <?php
                    }
                    ?>
