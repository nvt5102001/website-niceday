			...
			<div class="col-md-12">
					...
					<table>
						...
						<tbody>
							...
							if (isset($_SESSION['cart'])) {
								$i = 0;
								$tongtien = 0;
								// unset($_SESSION['totalProductInCart']);
							...
							?>
									<tr>
										<td class="product-remove">
											<a href="layout/main/cart/addCart.php?xoa=<?php echo $cart_item['id'] ?>"><i class="fa fa-trash-o"></i></a>
										</td>
										<td class="product-image">
											<img src="admin/modules/productManagement/uploads/<?php echo $cart_item['Image']; ?>" width="40%;">
										</td>
										...
										<td class="product-quantity product-cart-details">
											<a href="layout/main/cart/addCart.php?tru=<?php echo $cart_item['id'] ?>"><i class="fa fa-minus fa-style" aria-hidden="true" style="color:#333;margin:0 20px;"></i></a>
											<?php echo $cart_item['Quantity'];
											?>
											<a href="layout/main/cart/addCart.php?cong=<?php echo $cart_item['id'] ?>"><i class="fa fa-plus fa-style" aria-hidden="true" style="color:#333;margin:0 20px;"></i></a>
				...
				?>
					...
					<div class="shopingcart-bottom-area" style="margin:50px 0;">
						...
						<a href="layout/main/cart/addCart.php?xoatatca=1" class="bottomb">XOÁ TẤT CẢ</a>
						...
						<div class="bottom-button">
							...
							if ($block_DH == 1) {
								...
								echo "<a href='index.php?page=transport' class='bottomb'>TIẾP TỤC ĐẶT HÀNG</a>";
							}
							?>
						</div>
