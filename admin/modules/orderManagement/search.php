...
if ($tukhoa != " ") {
  $sql_lietke_dh = "SELECT * FROM tblretail_invoice,tblaccount 
    ...
    AND tblaccount.AccountName 
    LIKE '%" . $tukhoa . "%' ORDER BY tblretail_invoice.ReInvoiceID DESC LIMIT $begin,9";
          ...
          <div class="card-body">
            ...
            <div class="search-container">
              <form action="index.php?action=orderManagement&query=search" method="POST">
                <input type="text" placeholder="Enter your keyword..." name="tukhoaHD">
            ...
            <div class="table-responsive pt-3">
              ...
              $sql_trang = "SELECT * FROM tblretail_invoice,tblaccount 
                WHERE tblretail_invoice.CustomerAccID = tblaccount.AccountID 
                AND tblaccount.AccountName 
                LIKE '%" . $tukhoa . "%' ORDER BY tblretail_invoice.ReInvoiceID DESC";
