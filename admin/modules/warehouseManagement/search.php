...
if ($tukhoa != " ") {
  $sql_lietke_pnk = "SELECT * FROM tblimport_invoice,tblaccount WHERE tblimport_invoice.SupplierAccID=tblaccount.AccountID AND tblimport_invoice.ImportDate LIKE '%" . $tukhoa . "%' ORDER BY tblimport_invoice.ImInvoiceID DESC";
