...
$sql_lietke_sp = "SELECT * FROM tblproduct,tblbrand,tblcategory,tblcolor,tblstyle 
  WHERE tblproduct.BrandID = tblbrand.BrandID 
  and tblproduct.CategoryID = tblcategory.CategoryID
  and tblproduct.ColorID = tblcolor.ColorID
  and tblproduct.StyleID = tblstyle.StyleID
  ORDER BY ModifiedDate DESC LIMIT $begin,9";
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive pt-3">
                    ...
                    <tr>
                      <td>
                        <div style="display:flex;align-items:center;">
                          <a href="modules/productManagement/handle.php?ProductID=<?php echo $row['ProductID'] ?>" onClick="return confirm('Bạn có muốn xoá sản phẩm này không?');">
                      ...
                      <td><img src="modules/productManagement/uploads/<?php echo $row['Image'] ?>" width="150px"></td>
                    </tr>
                  <?php
                  }
                  ?>
              ...
              <?php
              $sql_trang = "SELECT * FROM tblproduct,tblbrand,tblcategory,tblcolor,tblstyle 
                WHERE tblproduct.BrandID = tblbrand.BrandID 
                and tblproduct.CategoryID = tblcategory.CategoryID
                and tblproduct.ColorID = tblcolor.ColorID
                and tblproduct.StyleID = tblstyle.StyleID";
